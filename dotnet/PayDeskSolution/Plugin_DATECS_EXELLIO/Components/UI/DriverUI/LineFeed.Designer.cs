...
{
    internal partial class LineFeed
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LineFeed));
            ...
            this.label1.Text = "К-сть рядків для пропуску";
            // 
            // LineFeed
            // 
            ...
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.LineFeed_KeyDown);
            this.Load += new System.EventHandler(this.LineFeed_Load);
