...
/* INTERNAL REFERENCE */
using MINI_FP6.DriverUI;
using MINI_FP6.Config;
using MINI_FP6.DriverUI.Customs;
using MINI_FP6.Components.UI.DriverUI;
...
namespace MINI_FP6
{
    ...
    public class Plugin_MINI_FP6 : ILegalPrinterDriver
    {
        // UI Components
