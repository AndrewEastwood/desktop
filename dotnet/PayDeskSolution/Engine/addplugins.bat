...
cp %PROJECT%\Plugin_DATECS_EXELLIO\bin\Debug\DATECS_EXELLIO.dll %PLUGINS_HOME%\DATECS_EXELLIO\
...
cp %PROJECT%\Plugin_DATECS_FP3530T\bin\Debug\DATECS_FP3530T.dll %PLUGINS_HOME%\DATECS_FP3530T\
...
cp %PROJECT%\Plugin_IKC-OP2\bin\Debug\IKC-OP2.dll %PLUGINS_HOME%\IKC-OP2\
...
cp %PROJECT%\Plugin_MINI-FP6\bin\Debug\MINI-FP6.dll %PLUGINS_HOME%\MINI-FP6\
