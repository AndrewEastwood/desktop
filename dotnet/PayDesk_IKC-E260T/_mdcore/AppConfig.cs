...
namespace mdcore
{
    ...
    public class AppConfig
    {
        ...
        public static object[] APP_UnitFilter = new object[2] { new string[0], new bool[0] };
        ...
        public static bool APP_AllowOneCopy = false;
        ...
        public static string[][] APP_PrintersLinks = new string[2][];
        public static bool APP_UseCommonPrinting = false;
        public static string APP_ClientCard = "";
        public static string APP_AddTotal = "none";
        public static bool APP_IllegalMsgPrompt = true;
        #endregion
        private const byte vars_sys = 38;
        ...
        #endregion Path
        private const byte vars_path = 13;
        ...
        public static string[] STYLE_ARTColumnName = { "ID", "BC", "NAME", "DESC", "UNIT", "VG", "TID", "TQ", "PACK", "WEIGHT", "PRICE", "PR1", "PR2", "PR3", "Q2", "Q3" };
        public static string[] STYLE_ColumnCaption ={ "Код", "Штрих-код", "Коротка назва", "Повна назва", "Одиниця", "ПДВ", "TID", "TQ", "PACK", "Вага", "Ціна", "PR1", "PR2", "PR3", "Q2", "Q3", "К-сть", "ПДВ%", "Знижка", "Знижка %", "Власна сума", "Сума", "Значення ПДВ", "К-сть", "Стартова ціна", "Надрукована к-сть" };
        public static string[] STYLE_ALTColumnName = { "ABC", "AID" };
        public static string[] STYLE_CARDColumnName = { "CBC", "CID", "CDISC", "CPRICENO" };
        ...
        #endregion View
        private const byte vars_style = 36;
        ...
        public static void SaveData()
        {
            ...
            system[35] = APP_ClientCard;
            system[36] = APP_AddTotal;
            system[37] = APP_IllegalMsgPrompt;
            #endregion
            //Path
            #region path
            ...
            object[] data = new object[1 + 1 + 1 + 1 + 1 + 1];
            data[0] = tax;
            data[1] = system;
            data[2] = path;
            data[3] = style;
            ...
            FileStream stream = new FileStream(Application.StartupPath + "\\Config.cfg", FileMode.Create, FileAccess.Write);
        ...
        public static void LoadData()
        {
            ...
            {
                BinaryFormatter binF = new BinaryFormatter();
                FileStream stream = new FileStream(Application.StartupPath + "\\Config.cfg", FileMode.Open, FileAccess.Read);
                ...
                try
                {
                    ...
                    APP_ClientCard = system[35].ToString();
                    APP_AddTotal = system[36].ToString();
                    APP_IllegalMsgPrompt = (bool)system[37];
                }
                catch { }
                #endregion
                //Path
